    	    ...
    	    <div class="x_panel">
    	        ...
    	        <div>
    	            <div class="x_content">
    	            	...
    	            	{{ Form::open(['method' => 'put','route'=>['admin.user_update','id'=>$user->id] , 'enctype'=>'multipart/form-data']) }}
                        ...
                        <div class="well" style="overflow: auto">
                            <div class="form-row mb-10">
                                ...
                                <div class="col-md-4 col-sm-12 col-xs-12 mb-3">
                                    ...
                                    <input type="date" class="form-control" name="dob"  placeholder="Enter Date Of Birth" value="{{$user->dob}}">
                                </div>
                                ...
                                <div class="col-md-4 col-sm-12 col-xs-12 mb-3" style="margin-top: 30px">
                                    ...
                                    <div class="col-md-6 col-sm-12 col-xs-12 mb-3">
                                        <p> Male : <input type="radio"  name="is_color"  value="M" {{$user->gender == 'M' ? 'checked' : ''}} />
                                            FeMale : <input type="radio" name="is_color"  value="F"  {{$user->gender == 'F' ? 'checked' : ''}}  />
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="well" style="overflow: auto">
                            <div class="form-row mb-10" >
                                <div class="col-md-4 col-sm-12 col-xs-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="state"  placeholder="Enter State Name" value="{{$user->state}}">
                                </div>

                                <div class="col-md-4 col-sm-12 col-xs-12 mb-3">
                                    <label for="city">City</label>
                                    <input type="text" class="form-control" name="city"  placeholder="Enter City Name" value="{{$user->city}}">
                                </div>

                                <div class="col-md-4 col-sm-12 col-xs-12 mb-3">
                                    <label for="pin">Pin</label>
                                    <input type="text" class="form-control" name="pin"  placeholder="Enter Pin Number" value="{{$user->pin}}">
                                </div>

                                <div class="col-md-12 col-sm-12 col-xs-12 mb-3">
                                    <label for="city">Address</label>
                                    <textarea class="form-control" name="city"  placeholder="Enter Address">{{$user->address}}</textarea>
                                </div>
                            </div>
                        </div>
