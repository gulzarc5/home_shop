    ...
    <div class="row">
    	...
    	<div class="col-md-12" style="margin-top:50px;">
    	    <div class="x_panel">
    	        ...
    	        <div class="x_title">
    	            <h2>Enter Refund Information Of Order Cancelletion Order Id = {{$order->id}}</h2>
    	        ...
    	        <div>
    	            <div class="x_content">
    	            	...
    	            	{{ Form::open(['method' => 'put','route'=>['admin.order_refund_info_insert','order_id'=>$order->id] , 'enctype'=>'multipart/form-data']) }}
                        ...
                        <div class="well" style="overflow: auto">
                            <div class="form-row mb-10">
                                ...
                                <div class="col-md-4 col-sm-12 col-xs-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="amt"  placeholder="Enter IFSC Code" disabled value="{{$order->amount+$order->shipping_charge}}">
                                </div>
