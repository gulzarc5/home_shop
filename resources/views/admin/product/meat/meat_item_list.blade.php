    ...
    <div class="row">
    	<div class="col-md-12 col-xs-12 col-sm-12" style="margin-top:50px;">
    	    <div class="x_panel">
    	        ...
    	        <div class="x_title">
    	            <h2>Meat Item List<b><button onclick="export_excel()"><i class="fa fa-file-excel-o" aria-hidden="true" style="font-size: 20px; color:#FF9800"></i></button></b></h2>
  ...
  <script type="text/javascript">
      $(function () {
        ...
        var table = $('#size_list').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('admin.product_list_ajax_meat') }}",
            columns: [
