    	    ...
    	    <div class="x_panel">
    	        ...
    	        <div>
    	            <div class="x_content">
    	            	...
    	            	{{ Form::open(['method' => 'put','route'=>['admin.delivery_boy_update','id'=>$user->id] , 'enctype'=>'multipart/form-data']) }}
                        ...
                        <div class="well" style="overflow: auto">
                            <div class="form-row mb-10">
                                ...
                                <div class="col-md-4 col-sm-12 col-xs-12 mb-3" style="margin-top: 30px">
                                    ...
                                    <div class="col-md-6 col-sm-12 col-xs-12 mb-3">
                                        <p> Male : <input type="radio"  name="gender"  value="M" {{$user->gender == 'M' ? 'checked' : ''}} />
                                            FeMale : <input type="radio" name="gender"  value="F"  {{$user->gender == 'F' ? 'checked' : ''}}  />
                                        </p>
                                    </div>
                                </div>
                            </div>
