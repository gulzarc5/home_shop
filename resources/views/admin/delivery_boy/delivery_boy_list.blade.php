    	...
    	<div class="col-md-12 col-xs-12 col-sm-12" style="margin-top:50px;">
    	    <div class="x_panel">
    	        ...
    	        <div class="x_title">
                    ...
                    <h2 style="float: right"><a href="{{route('admin.delivery_boy_add_form')}}" class="btn btn-sm btn-warning">Add New Delivery Boy</a></h2>
  ...
  <script type="text/javascript">
      $(function () {
        ...
        var table = $('#size_list').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('admin.delivery_boy_list_ajax') }}",
            columns: [
